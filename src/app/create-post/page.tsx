...
export default function CreatePost() {
  ...
  return (
    <>
      ...
      <div className="sm:px-10 px-0 h-[calc(100vh-80px)] bg-gradient-to-br from-gray-950 to-gray-900 overflow-y-hidden">
        <form onSubmit={handleSubmit(onSubmit)} className="flex h-full">
          {/* LEFT */}
          <div className="w-1/2 p-4 flex flex-col border-r border-gray-700 overflow-y-scroll">
            <input
